...
class CircularShuffleOrder private constructor(
    ...
    companion object {
        private const val TAG = "CircularShuffleOrder"
        ...
        private fun calculateListWithFirstIndex(shuffled: IntArray, firstIndex: Int): IntArray {
            ...
            val before = shuffled.slice(0 until fi)
            val inclAndAfter = shuffled.slice(fi until shuffled.size)
        ...
        companion object {
            fun deserialize(data: String?): Persistent {
                ...
                return try {
                    ...
                    Log.e(TAG, "gave up trying to restore shuffle order", e)
